    ...
    <div class="mb-8 w-full max-w-sm mx-auto sm:max-w-none">
      ...
      >
        <div class="flex items-center gap-3 text-[#304830]">
          <div
            class="w-8 h-8 rounded-full bg-[#C0D890]/50 flex items-center justify-center"
          >
      ...
      >
        <div
          class="flex flex-col items-center text-center p-4 rounded-2xl bg-white/50 backdrop-blur-sm border border-[#90C078]/30 shadow-sm"
        >
          <div
